$.get({
    url: "https://api.github.com/repos/xzyweb/xzyweb.github.io/issues?state=open&labels=置顶",
    dataType: "json",
...
$.get({
    url: "https://api.github.com/repos/xzyweb/xzyweb.github.io/issues?state=open&per_page=10&page=1",
    dataType: "json",
    success: function(data) {
        if (!data.hasOwnProperty('message')) {
			var body="";
